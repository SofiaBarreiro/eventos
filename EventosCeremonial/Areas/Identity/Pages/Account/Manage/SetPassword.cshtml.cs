...
namespace EventosCeremonial.Areas.Identity.Pages.Account.Manage
{
    public class SetPasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(10, ErrorMessage = "La contraseña {0} debe tener al menos {2} y como máximo {1} caracteres de largo.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "La contraseña ha sido enviada.";
